...
public class CandidatePublicProfileController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYER')")
    public ResponseEntity<List<CandidatePublicProfileResponse>> getAllCandidatePublicProfiles() {

        var response = candidatePublicProfileService.getAllCandidatePublicProfiles();
